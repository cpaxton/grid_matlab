function [traj, nodes] = run_mcts_sampling_test(env, models, fig)
...
%x0 = [600; 800; 0; 0; 0];
x0 = [190; 1000; 0; 0; 0];
config = make_default_mcts_config(0);
config.num_iter = 50;
action_config = make_default_action_config();
action_config.allow_repeats = true;
action_config.fixed_num_primitives = false;
