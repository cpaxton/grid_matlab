function config = no_rollouts_pw_config()
    C = 1;
    alpha = 0.5;
    ...
    config = struct('update', 0, ...
                    ...
                    'choose_child', @(nodes, curr_node, curr_traj) random_child(nodes, curr_node, curr_traj), ... % ucb1_child or random_child or greedy_child
                    ...
                    'num_iter', 1000, ... max number of iterations to perform
